...
app.config(function($routeProvider) {
  ...
  $routeProvider.when('/accordion', {templateUrl: 'demo/accordion.html', reloadOnSearch: false});
  $routeProvider.when('/overlay', {templateUrl: 'demo/overlay.html', reloadOnSearch: false});
  $routeProvider.when('/forms', {templateUrl: 'demo/forms.html', reloadOnSearch: false});
  $routeProvider.when('/dropdown', {templateUrl: 'demo/dropdown.html', reloadOnSearch: false});
